...
<body>
    ...
    <section class="abthome">
        ...
        <div class="left-column">
                <h1>ALL ABOUT ME</h1><br><br>
                <h3>I'm a <span class="text"></span></h3><br>
                <h2><i class="fas fa-user"></i> Profile Summary</h2><br>
                <p>As a third-year BSIT student, I'm passionate about computer studies and dedicated to learning. My academic journey has equipped me with a solid foundation in programming and a comprehensive understanding of modern technology trends.</p><br>
                <h2><i class="fas fa-graduation-cap"></i> Education</h2><br>
                <p>Commencing at Del Rosario Elementary School in Pilar, Sorsogon, my academic journey began, culminating in graduation in 2016. Progressing through Salvacion National High School for Junior High School until 2020, followed by completion of the Senior High School phase with a STEM focus in 2022. Currently immersed in my second year pursuing a Bachelor of Science in Information Technology at Bicol University, each milestone signifies a dedicated commitment to ongoing learning and academic excellence.</p>
            </div> 
            <div class="right-column">
                <div class="picture">
                <img src="{{ asset('images/me.jpg') }}" alt="Myself">
                <img src="{{ asset('images/akes.jpg') }}" alt="Myself">
                <img src="{{ asset('images/ako.jpg') }}" alt="Myself">
                <h2><i class="fas fa-heart"></i> Hobbies or Interests</h2><br>
                <p>During my leisure time, I enjoy reading and writing, which enhance my intellectual curiosity and creativity, enriching my personal growth and leisure experiences with exploration and self-expression.</p>
             </div>
        ...
        <a href="{{ url('/content') }}" class="btn-box"> More </a>
